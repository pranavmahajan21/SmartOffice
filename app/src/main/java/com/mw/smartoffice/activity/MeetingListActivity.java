...
import com.mw.smartoffice.adapter.MeetingAdapter;
...
public class MeetingListActivity extends AndhraActivity {
    ...
    private void initThings() {
        ...
        if (meetingMap != null && meetingMap.size() > 0) {
            adapter = new MeetingAdapter(this, meetingMap);
        }
...
//                startActivity(nextIntent);
                ...
                Toast.makeText(MeetingListActivity.this, "position before : " + position, Toast.LENGTH_SHORT).show();

                nextIntent = new Intent(MeetingListActivity.this, MeetingAddActivity.class);
                nextIntent.putExtra("position", position);
...
//                    adapter.notifyDataSetChanged();
                    ...
                    calendarAdapter = new CalendarAdapter(MeetingListActivity.this, selectedDateCalendar);
